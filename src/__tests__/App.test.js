...
import userEvent from "@testing-library/user-event";// Added import for events
import App from "../App";
...
test("pizza checkbox initially unchecked", () => {
    render(<App />);
...
test("toppings listings initially contains only cheese", () => {
    render(<App />);
